...
class MenuWindow extends ActionWindow {
    public function getWindow() {
        ...
        $buttons .= '<a href="'. base_url("app") . '?window=pos">' . Input::htmlButton(IconDictionary::$pen. '<br><div>POS</div>', ['class' => 'button']) . '</a>';
        ...
        $buttons .= '<a href="'. base_url("logout") . '">' . Input::htmlButton(IconDictionary::$logout. '<br><div>Đăng xuất</div>', ['class' => 'button']) . '</a>';   
